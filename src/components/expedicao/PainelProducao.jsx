...
import { ChefHat, AlertTriangle, Clock, User, CiFries, FaHamburger, PiHamburgerFill } from ".././shared/Icones";
    ...
    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-6">
      <PanelCard
        ...
        items={Object.entries(contadorFila).map(([name, quantity]) => ({
          icon: name === 'KFT' ? <FaHamburger /> : name === 'Falafel' ? <PiHamburgerFill /> : name === 'Marys' ? <FaHamburger /> : name === 'Fritas' ? <CiFries /> : null,
          name,
          quantity,
        }))}
        color="blue"
